...
>
> Este checklist cubre los criterios verificables en Figma. Los criterios de implementación (orden de foco real, ARIA labels, semántica HTML) deben verificarse en el código durante el desarrollo. Los estados de foco visual están planificados para la **versión 1.1** del sistema.
---
